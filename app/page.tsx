    ...
    return (
        <div className="bg-[--bg] text-[--text]">
            ...
            <section className="relative w-full">
                <div className="relative w-full aspect-[4/4] md:aspect-video max-h-none md:max-h-[55vh] 2xl:max-h-[50vh]">
                    {/* Mobile image */}
                    <Image
                    ...
                    <div className="absolute inset-x-4 top-0 bottom-0 sm:inset-x-6 md:inset-0 flex items-start md:items-center justify-center py-16 md:py-0">
                        <div className="text-center px-6 sm:px-10 md:px-6 max-w-[92vw] md:max-w-4xl">
                            <h1 className="font-display tracking-wide text-3xl sm:text-4xl md:text-6xl uppercase">
                                Idioter med computere
                            </h1>
                            <p className="text-white mt-3 text-[--text-dim] text-base sm:text-lg md:text-xl">
                                Om alt det der går galt mellem mennesker og maskiner
                            </p>
                            <a
                                href="/subscribe"
                                className="mt-10 inline-flex items-center justify-center bg-[--accent] text-white font-display font-bold uppercase rounded-2xl px-10 py-5 text-xl sm:text-2xl shadow-[0_0_40px_rgba(155,93,229,0.4)] hover:ring-2 hover:ring-[--accent]"
                                aria-label="Abonnér på Idioter med computere"
                            >
                                Abonnér
                            </a>
                        </div>
